...
class Dahsboard extends CI_Controller {
	...
	{ 
		...
		if($this->session->userdata('dbd')=="kopasus"){
			$this->db  = $this->load->database('default', TRUE);
		}elseif($this->session->userdata('dbd')=="material"){
			$this->db  = $this->load->database('material', TRUE);
		}
	...
	public function index($id_db="kopasus")
	{
		...
		$data['dbd'] = $this->session->userdata('dbd');
	...
	public function change_db($id_db='')
	{
		if($id_db=="kopasus"){
			$this->session->set_userdata(["dbd" => "default"]);
		}elseif($id_db=="material"){
			$this->session->set_userdata(["dbd" => "material"]);
		}
		redirect('dahsboard');
	}
